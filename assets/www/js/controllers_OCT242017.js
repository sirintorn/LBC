 ...
 //               alert(lineBalancceViewID);
            ...
            $scope.print = function() {
                if($cordovaPrinter.isAvailable()) {
                    ...
                    page += '<title>Title of the document</title>';
                    page += '<style>';
                    page += 'body{';
                    page += 'font-size: 20px;';
                    page += '}';
                    ...
                    page += '</tr>';
                    page += '<tr>';
                    page += '<td style="padding-left: 2px; padding-right: 2px; height: 100%px;">';
                    ...
                    page += 'รหัสพนักงาน : '+cdt_std_data.employee+' &emsp; ชื่อพนักงาน : <br><br>';
                    page += 'WIP: '+$scope.cdt_std.wip+' ตัว &emsp; Lot ส่ง : '+$scope.cdt_std.lott+' ตัว<br><br>';
                    page += 'ขั้นตอนเย็บ : '+cdt_std_data.step+'<br><br><br>';
                    page += 'Takt Time : '+parseFloat(((60 / $scope.cdt.otp_target) - 0).toFixed(3))+' นาที &emsp; Cycle Time : '+parseFloat((cdt_std_data.cycletime - 0).toFixed(3))+' ตัว';
                    page += '</td>';
                    page += '</tr>';
                    page += '</table>';
                    page += '</body>';
...
//                alert(style_data.style);
                ...
                getLbMainByCdt(request, function (data) {
                    ...
                    if (data.errorcode == "OK") {
                        ...
                        //b = (lb_main_data.otp_target - 0).toFixed(3);
                        ...
                        $scope.cdt.last_update = lb_main_data.create_datetime;
//                        $scope.cdt.income = (lb_main_data.income- 0).toFixed(2);
                        $scope.cdt.income = lb_main_data.income- 0;
   ...
   //                 alert(kaizen_data.before_detail);
            ...
            $scope.print = function() {
                if($cordovaPrinter.isAvailable()) {
                    ...
                    page += '      	</table>';
                    page += '      </td>';
                    page += '      <td style="height: 3.4cm; border: 1px solid black;width: 9.8cm;font-size: 10;text-align: left;vertical-align: top;padding: 0.25cm">หลังทำ : '+kaizen_data.after_detail+'</td>';
                    page += '    </tr>';
                    page += '     <tr>';
                    page += '      <td colspan="5" style="height: 2.2cm;padding-left: 0.5cm; font-size: 10;line-height: 0.5cm;"><b><u>การคำนวณผลลัพธ์ที่เป็นตัวเงิน</u></b> <b><u>ค่ามาตรฐาน</u></b> 1.รายรับต่อนาทีแรงงาน = 1.959 บาท&emsp;2.กระดาษ A4 ถ่าย(80แกรม) แผ่นละ0.17บาท&emsp;3.กระดาษ A4 พิมพ์(70 แกรม) แผ่นละ0.14 บาท&emsp;4.กระดาษ F14 แผ่นละ 0.22 บาท <br>';
