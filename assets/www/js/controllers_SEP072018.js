...
//                alert(style_data.style);
                ...
                getLbMainByCdt(request, function (data) {
                    ...
                    if (data.errorcode == "OK") {
                        ...
                        $scope.cdt.bn_position = lb_main_data.bn_position;
                        $scope.cdt.bn_employee = lb_main_data.bn_employee;
                        $scope.cdt.bn_output = (lb_main_data.bn_output-0).toFixed(3);
                        $scope.cdt.bn_eff = (lb_main_data.bn_eff - 0).toFixed(0);
...
//                        $scope.cdt.factory_obj = {};
            ...
            function updateFormLbMain(data_obj) {
                ...
                var bn_eff = parseFloat((((bn_output * $scope.cdt.total_sam) / (man * 60)) * 100).toFixed(0));
...
//
//                                }else if(diff < 0){
                                    percent = ($scope.cdt_dl_timer.gsd_sam / $scope.cdt_dl_timer.cycletime)*100;
//                                }else{
//                                    percent = 100;
//                                }
